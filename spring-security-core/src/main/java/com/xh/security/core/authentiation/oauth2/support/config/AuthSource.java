package com.xh.security.core.authentiation.oauth2.support.config;
 ...
 * ③、如果扩展了对应枚举类时，在{@link AuthRequest#login(com.xh.security.core.authentiation.oauth2.support.model.AuthCallback)}中可以通过{@code xx.toString()}获取对应的source
 *
