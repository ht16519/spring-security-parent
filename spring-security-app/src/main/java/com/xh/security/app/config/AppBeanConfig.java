...
public class AppBeanConfig {
    ...
    /** 配置登录成功处理器*/
    @Bean(KeyConst.APP_AUTHENTICATION_SUCCESS_HANDLER_BEAN_NAME)
    @ConditionalOnMissingBean(name = KeyConst.APP_AUTHENTICATION_SUCCESS_HANDLER_BEAN_NAME)
    public SavedRequestAwareAuthenticationSuccessHandler successHandler() {
        return new AppAuthenticationSuccessHandler(securityProperties);
    }

    /** 配置登录失败处理器*/
    @Bean(KeyConst.APP_AUTHENTICATION_FAILURE_HANDLER_BEAN_NAME)
    @ConditionalOnMissingBean(name = KeyConst.APP_AUTHENTICATION_FAILURE_HANDLER_BEAN_NAME)
    public SimpleUrlAuthenticationFailureHandler failureHandler() {
        return new AppAuthenticationFailureHandler(securityProperties);
    }

    /** 配置登录失败处理器*/
    @Bean(KeyConst.APP_LOGOUT_SUCCESS_HANDLER_BEAN_NAME)
    @ConditionalOnMissingBean(name = KeyConst.APP_LOGOUT_SUCCESS_HANDLER_BEAN_NAME)
